...
public class GetOfficesRequestModel : ICacheable
{
    [DefaultValue("BGR")]
    ...
    public GetOfficesRequestDto ToGetOfficesRequestDto()
    {
        return new GetOfficesRequestDto
        {
            CountryCode = this.CountryCode,
            CityId = this.CityId,
            ShowCargoReceptions = this.ShowCargoReceptions,
            ShowLogisticCenter = this.ShowLogisticCenter,
        };
    }
}
